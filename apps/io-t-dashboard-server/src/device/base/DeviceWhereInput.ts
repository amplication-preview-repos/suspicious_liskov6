...
import { IoTDataListRelationFilter } from "../../ioTData/base/IoTDataListRelationFilter";
...
class DeviceWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => IoTDataListRelationFilter,
  })
  @ValidateNested()
  @Type(() => IoTDataListRelationFilter)
  @IsOptional()
  @Field(() => IoTDataListRelationFilter, {
    nullable: true,
  })
  ioTDataItems?: IoTDataListRelationFilter;
